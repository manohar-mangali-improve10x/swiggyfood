...
public class Swiggy1Activity extends AppCompatActivity {
    ...
    private void setUpAdapterclickListener() {
        adapter.click = new SwiggyItemsOnClick() {
            @Override
            public void swiggyItemOnClickListener(SwiggyItems items) {
                Toast.makeText(Swiggy1Activity.this, items.item, Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Swiggy1Activity.this,Swiggy6Activity.class);
